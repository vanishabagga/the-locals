...
import img1 from './foodc.webp';
import img2 from './attractc.jpg';
import img3 from './shopc.webp';
import img4 from './nightc.jpg';
...
const Category = () => {
  ...
  return (
    <div>
      ...
      <h2 style={{ textAlign: 'center', marginTop: '40px', marginBottom: '20px' }}>Categories</h2>
